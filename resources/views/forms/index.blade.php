		...
		<div class="">
					...
					<div class="x_panel">
						...
						<div class="x_content">
							...
							<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
								...
								<div class="item form-group">
									<label class="col-form-label col-md-3 col-sm-3 label-align" for="last-name">Jenis Wisata <span class="required">*</span>
									</label>
									<div class="col-md-6 col-sm-6 ">
			...
			{{-- <div class="row">
				...
				<div class="col-md-12 col-sm-12 ">
					<div class="x_panel">
						<div class="x_title">
							<h2>Form Data Wisata<small>different form elements</small></h2>
							<ul class="nav navbar-right panel_toolbox">
								<li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
								</li>
								<li><a class="close-link"><i class="fa fa-close"></i></a>
						...
						<div class="x_content">
							...
							<form class="form-horizontal form-label-left">
								...
								<div class="form-group row ">
									<label class="control-label col-md-3 col-sm-3 ">Nama{{ $form->nama }}<span class="required">*</span></label>
									<div class="col-md-9 col-sm-9 ">
										<input type="varchar" class="form-control" placeholder="Masukkan Nama Tempat Wisata">
									</div>
								</div>
								<div class="form-group row">
									<label class="control-label col-md-3 col-sm-3 ">Jenis Wisata{{ $form->jenis }}<span class="required">*</span></label>
									<div class="col-md-9 col-sm-9 ">
										<input type="varchar" class="form-control" placeholder="Masukkan Jenis Wisata">
									</div>
								</div>
								<div class="form-group row">
									<label class="control-label col-md-3 col-sm-3 ">Harga{{ $form->harga }}<span class="required">*</span></label>
									<div class="col-md-9 col-sm-9 ">
										<input type="biginteger" class="form-control" placeholder="Masukkan Harga">
									</div>
								</div>
								<div class="form-group row">
									<label class="control-label col-md-3 col-sm-3 ">Region{{ $form->id_region }}<span class="required">*</span></label></label>
									<div class="col-md-9 col-sm-9 ">
								...
								<div class="form-group row">
									<label class="control-label col-md-3 col-sm-3 ">Kecamatan{{ $wisata->id_kecamatan }}<span class="required">*</span></label></label>
									<div class="col-md-9 col-sm-9 ">
										<select class="select2_single form-control" tabindex="-1">
											<option></option>
								...
								<div class="form-group row">
									<label class="control-label col-md-3 col-sm-3 ">Alamat{{ $wisata->alamat }}<span class="required">*</span>
									</label>
									<div class="col-md-9 col-sm-9 ">
										<input type="varchar" textarea class="form-control" rows="3" placeholder="Masukkan Alamat"></textarea>
									</div>
								</div>
								<div class="form-group row">
									<label class="control-label col-md-3 col-sm-3 ">Deskripsi{{ $wisata->deskripsi }}</label>
									<div class="col-md-9 col-sm-9 ">
										<input type="varchar" textarea class="form-control" rows="3" placeholder="Masukkan Deskripsi"></textarea>
									</div>
								</div>
								<div class="form-group row">
									<label class="control-label col-md-3 col-sm-3 ">Fasilitas{{ $wisata->fasilitas}}</label>
									<div class="col-md-9 col-sm-9 ">
										<input type="varchar" textarea class="form-control" rows="3" placeholder="Masukkan Fasilitas"></textarea>
									</div>
								</div>
								<div class="form-group row">
									<label class="control-label col-md-3 col-sm-3 ">Social Media{{ $wisata->sosmed }}</label>
									<div class="col-md-9 col-sm-9 ">
